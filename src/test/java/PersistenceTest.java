...
public class PersistenceTest {
    ...
    void test2() {
        try {
            ...
            Memo memo = em.find(Memo.class, 1); //em.find(내가 찾고자하는 엔티티 클래스, id)
    ...
    void test3() {
        try {
            ...
            //select가 한번 나오면 첫번째 find에 가져오고 다음번엔 캐시저장소에 가져온거고
            // 두번 나오면 찾을 때마다 db에서 가져오는 것
    ...
    void test7() {
        EntityTransaction et = em.getTransaction(); //트랜잭션 환경이 있어야 데이터변경하는 요청을 DB에 할 수 있음 (insert,updqte,delete)
